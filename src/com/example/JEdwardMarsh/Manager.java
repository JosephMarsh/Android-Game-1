...
public class Manager extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       backImage =  ResourcesCompat.getDrawable(getResources(), R.drawable.icon,null);
	...
	private View createImageButton(int x, int y){
    	...
    	//button.setBackgroundDrawable(backImage); this code is deprecated updated by me
    ...
    class ButtonListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			//play sound when user clicks a tile
		...
		private void turnCard(Button button,int x, int y) {
			//button.setBackgroundDrawable(images.get(cards[x][y]));Deprecated
			...
			if(firstCard==null){
				...
				if(firstCard.x == x && firstCard.y == y){
					//play sound when user presses the same card
					mPlayer.play2(context); 
